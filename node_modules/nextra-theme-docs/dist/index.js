    ...
    Select,
    {
      ...
      selected: {
        ...
        name: /* @__PURE__ */ jsxs19("div", { className: "nx-flex nx-items-center nx-gap-2 nx-capitalize", children: [
          ...
          /* @__PURE__ */ jsx28("span", { className: lite ? "md:nx-hidden" : "", children: mounted ? theme2 : "light" })
        ] })
      }
    }
  );
...
var themeSchema = z2.strictObject({
  ...
  search: z2.strictObject({
    ...
    loading: z2.string().or(z2.function().returns(z2.string())),
...
var classes6 = {
  ...
  main: cn21("nx-w-full nx-overflow-x-hidden nx-break-words")
};
var Body = ({
  themeContext,
  breadcrumb,
